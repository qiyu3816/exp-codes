...
public class HTTPServer {
     ...
     * @throws IOException
     */
    public HTTPServer(String rootDirectory) throws IOException {
    ...
    public void servive(){
        ...
        while(true) {
            try {
                ...
                executorService.execute(new HTTPHandler(socket, rootFile.getAbsolutePath()));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
