 ...
 * 
 */
@WebServiceClient(name = "WebServerService", targetNamespace = "http://www.service.com", wsdlLocation = "http://127.0.0.1:8001/mywebservice/myservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8001/mywebservice/myservice?wsdl");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://www.service.com", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.service.com", "MyWebServicePort"), MyWebService.class, features);
    }
